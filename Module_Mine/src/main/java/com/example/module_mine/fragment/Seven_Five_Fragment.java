 ...
 */
public class Seven_Five_Fragment extends Fragment implements View.OnClickListener {
    ...
    private void init(){
        ...
        if(sharedPreferences.getInt("competition_4",0)==1){
